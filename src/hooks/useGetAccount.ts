import { getAccountCostTrend, getAccountDetail, getAccountInvoices, getServiceLocations, getServiceTypesVendor, getVendorTickets } from '@/services/accounts/accountsService'
