...
export function SelectComponent({ menuOption, index }: { menuOption: MenuOption; index: number }) {
	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			<PopoverTrigger asChild className="bg-[#F4F7FE] outline-none">
				<Button variant="outline" role="combobox" aria-expanded={open} className="w-[200px] justify-between" value={12}>
