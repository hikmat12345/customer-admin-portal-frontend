...
const InvoicesProcessed = ({ data, title, isLoading }: any) => {
	return (
		<div className="min-w-[300px] min-h-[150px] lg:min-h-[140px] xl:min-h-[155px] h-auto border border-custom-plaster pl-7 pt-3 rounded-lg relative">
			{isLoading ? (
				...
				<div className="flex gap-[6px]">
					<div className="flex flex-col gap-4 pb-3 w-full pr-5">
						<h2 className="text-custom-black text-sm md:text-base xl:text-lg font-semibold">{title}</h2>
