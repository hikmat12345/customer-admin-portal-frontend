        ...
        <div className="w-[100%] max-lg:mt-5 max-lg:w-[100%]">
          <div className="w-[100%]">
            <div className="flex gap-2 py-1.5">
              ...
              <div className="w-[50%] text-[#57575  text-left lg:text-[13px] lg:leading-6 xl:text-[14px] xl:leading-7">
            ...
            <div className="flex gap-2 py-1.5">
              ...
              <div className="w-[50%] text-[#575757]    text-left lg:text-[13px] lg:leading-6 xl:text-[14px] xl:leading-7">
