        ...
        <div className="w-[100%] max-lg:mt-5 max-lg:w-[100%]">
          <div className="w-[100%]">
            <div className="flex gap-2 py-1.5">
              <div className="w-[50%] font-[600] lg:text-[13px] lg:leading-6 xl:text-[16px] xl:leading-7">Address</div>
              <div className="w-[50%] text-left lg:text-[12px] lg:leading-6 xl:text-[14px] xl:leading-7">
                {remittanceData?.remittanceAddress}
              </div>
            </div>

            <div className="flex gap-2 py-1.5">
              <div className="w-[50%] font-[600] lg:text-[13px] lg:leading-6 xl:text-[16px] xl:leading-7">
                Matched Status
              </div>
              <div className="w-[50%] text-left lg:text-[12px] lg:leading-6 xl:text-[14px] xl:leading-7">
