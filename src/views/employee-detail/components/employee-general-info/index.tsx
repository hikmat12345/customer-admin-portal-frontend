...
export default function SiteGeneralInfo({
    ...
    const keys = [
        ...
        { label: 'Status', value: status !== null ? <span className={`inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs text-white font-medium cursor-pointer ${status === 1 ? 'bg-[#219653]' : 'bg-custom-deepRed'}`}>
