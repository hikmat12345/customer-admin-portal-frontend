...
import {  EmployeeGeneralInfoProps } from "@/types/site";
                ...
                <div className="flex max-lg:block gap-[19px] pb-6">
                    <div className="flex w-[42%]  max-lg:w-[100%] max-lg:mt-5  justify-between  ">
                        <div className='w-[34%]'>
                            ...
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">First Name</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Email</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Status</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Site</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Manage ID</div>
                        </div>
                        <div className='w-[66%]'>
                    ...
                    <div className="flex w-[45%] max-lg:w-[100%] max-lg:mt-5  justify-center gap-10 pr-20"> 
                        <div className=''>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Client Employee ID</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Last Name</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Job Title</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Employee Level</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">Cost Center</div>
                            <div className="text-[#000] lg:text-[13px] xl:text-[16px] font-[600] leading-9">VIP Executive</div>
                        </div>
                        <div >
