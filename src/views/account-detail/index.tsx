...
import { useGetAccountCostTrend, useGetAccountDetail, useGetAccountInvoices, useGetAccountTickets, useGetServiceLocations, useGetServiceTypesVendor } from '@/hooks/useGetAccount'
				...
				<div id="service-type">
					...
					{isVendorServiceTypeLoading ?
						...
						Array.isArray(vendorServicesTypes?.data) && vendorServicesTypes?.data.length > 0 ?
							<ServiceTypesGrid services={vendorServicesTypes?.data.sort((a: {
