  ...
  return (
    <div>
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <div className="">
          <TabsList className="sm:mb-[45px] sm:block sm:w-full sm:gap-[1rem] 2md:block 2md:w-[85%] 2md:gap-[2rem] lg:mb-[30px] lg:block 2lg:mb-[30px] 2lg:w-[100%]">
            {tabs.map((tab, index) => (
              <TabsTrigger
                key={index}
                value={tab}
        ...
        <div
          ...
          className="relative mt-5 h-[75vh] overflow-y-scroll rounded-lg border border-neutral-300 p-5"
        >
          <div
            style={{
              position: 'absolute',
