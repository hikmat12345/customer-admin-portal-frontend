  ...
  return (
    <div className="overflow-auto lg:max-h-[220px] xl:max-h-full">
      <Table>
        ...
        <TableBody>
          <TableRow>
            <TableCell className="p-5 text-sm font-normal xl:text-base">High Spend Alert</TableCell>
            <TableCell className="p-5 text-justify text-sm font-normal xl:text-base">
              Lorem ipsum dolor sit amet consectetur. Eu viverra aenean amet lacinia sed ac malesuada in. Et pretium sit
              id sed amet enim.
            </TableCell>
            <TableCell className="p-5 text-sm font-normal xl:text-base">01/15/2024</TableCell>
            <TableCell className="">
              <Image
          ...
          <TableRow>
            <TableCell className="p-5 text-sm font-normal xl:text-base">Saving Recommendation</TableCell>
            <TableCell className="p-5 text-justify text-sm font-normal xl:text-base">
              Lorem ipsum dolor sit amet consectetur. Eu viverra aenean amet lacinia sed ac malesuada in. Et pretium sit
              id sed amet enim.
            </TableCell>
            <TableCell className="p-5 text-sm font-normal xl:text-base">02/09/2024</TableCell>
            <TableCell className="">
              <Image
          ...
          <TableRow>
            <TableCell className="text-sm font-normal xl:text-base">Upgrade Approval</TableCell>
            <TableCell className="text-justify text-sm font-normal xl:text-base">
              Office ipsum you must be muted. 30,000ft incompetent wiggle resources level diarize.
            </TableCell>
            <TableCell className="text-sm font-normal xl:text-base">03/11/2024</TableCell>
            <TableCell>
              <Image
                src="/svg/highlightedCheckbox.svg"
                alt="Checked"
