...
function SelectComponent(props: IProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild className="flex flex-row items-center bg-custom-blue outline-none">
        ...
        <Command>
          <CommandGroup>
            <div className="border-b">
              <h6 className="px-1 py-2 text-sm font-bold text-custom-slate-700">Filters</h6>
            </div>
          </CommandGroup>
          <CommandGroup>
            <CommandList>
