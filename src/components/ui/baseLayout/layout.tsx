...
const BaseLayout = ({ children }: { children: React.ReactNode }) => {
	...
	return (
		<div className="flex">
			<Sidebar />
			<div className="flex flex-col py-[1rem] pl-[300px] pr-[55px] w-full min-h-[100vh] max-h-full bg-custom-background">
				<div className="flex items-center justify-between mb-4">
					<div className="flex items-center gap-5 relative">
						...
						<h2 className="capitalize font-bold text-custom-black text-[34px]">{endWord}</h2>
					</div>
					<SearchTextFieldArea />
				</div>
				{children}
