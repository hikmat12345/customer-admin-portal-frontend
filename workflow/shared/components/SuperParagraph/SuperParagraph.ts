...
import type { ParagraphStatesType } from './SuperParagraphType';

abstract class SuperParagraph<P extends WorkflowDataType> extends SuperComponent<P, ParagraphStatesType> {
  constructor(props: P) {
    super(props);
  }
