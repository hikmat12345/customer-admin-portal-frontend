...
import type { NewEmployeeStatesType } from './SuperNewEmployeeType';

abstract class SuperNewEmployee<P extends WorkflowDataType> extends SuperComponent<P, NewEmployeeStatesType> {
  constructor(props: P) {
    super(props);
    this.state = {
      isOpen: false
...
export default SuperNewEmployee;
