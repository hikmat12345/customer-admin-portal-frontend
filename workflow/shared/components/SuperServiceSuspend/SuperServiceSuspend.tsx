...
import { getCatalogApiCall, Strings } from '../..';
import type { WorkflowDataType } from '../../types';
import { isNotNullOrEmpty } from '../../utils';
import { SuperComponent } from '../SuperComponent';
import type { SuperServiceSuspendType } from './SuperServiceSuspendType';

class SuperServiceSuspend<P extends WorkflowDataType> extends SuperComponent<P, SuperServiceSuspendType> {
  constructor(props: P) {
    super(props);
    this.state = {
      value: props.value || '',
...
export default SuperServiceSuspend;
